...
QtObject {
  readonly property var defaults: ({
    ...
    particleCount: 7,
    particleLifetime: 720,
    particleSize: 3,
    particleSpread: 105,
    initialVelocity: 210,
    gravity: 340,
    opacity: 1,
    maximumActiveParticles: 220,
    particleTrail: true,
    cursorFlash: true,
    shakeEnabled: false,
    shakeStrength: 2,
  ...
  function sanitized(raw) {
    ...
    return {
      ...
      particleTrail: boolean(raw.particleTrail, d.particleTrail),
      cursorFlash: boolean(raw.cursorFlash, d.cursorFlash),
